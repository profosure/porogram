 ...
 */
package com.porogram.profosure1.messenger.exoplayer2;
...
import com.porogram.profosure1.messenger.exoplayer2.audio.AudioCapabilities;
import com.porogram.profosure1.messenger.exoplayer2.audio.AudioRendererEventListener;
import com.porogram.profosure1.messenger.exoplayer2.audio.AudioTrack;
import com.porogram.profosure1.messenger.exoplayer2.audio.MediaCodecAudioRenderer;
import com.porogram.profosure1.messenger.exoplayer2.decoder.DecoderCounters;
import com.porogram.profosure1.messenger.exoplayer2.drm.DrmSessionManager;
import com.porogram.profosure1.messenger.exoplayer2.drm.FrameworkMediaCrypto;
import com.porogram.profosure1.messenger.exoplayer2.mediacodec.MediaCodecSelector;
import com.porogram.profosure1.messenger.exoplayer2.metadata.Metadata;
import com.porogram.profosure1.messenger.exoplayer2.metadata.MetadataRenderer;
import com.porogram.profosure1.messenger.exoplayer2.metadata.id3.Id3Decoder;
...
import com.porogram.profosure1.messenger.exoplayer2.text.Cue;
import com.porogram.profosure1.messenger.exoplayer2.text.TextRenderer;
import com.porogram.profosure1.messenger.exoplayer2.trackselection.TrackSelectionArray;
import com.porogram.profosure1.messenger.exoplayer2.trackselection.TrackSelector;
import com.porogram.profosure1.messenger.exoplayer2.video.MediaCodecVideoRenderer;
import com.porogram.profosure1.messenger.exoplayer2.video.VideoRendererEventListener;
...
public class SimpleExoPlayer implements ExoPlayer {
  ...
  protected void buildVideoRenderers(Context context, Handler mainHandler,
    ...
    try {
      Class<?> clazz =
          Class.forName("com.porogram.profosure1.messenger.exoplayer2.ext.vp9.LibvpxVideoRenderer");
  ...
  protected void buildAudioRenderers(Context context, Handler mainHandler,
    ...
    try {
      Class<?> clazz =
          Class.forName("com.porogram.profosure1.messenger.exoplayer2.ext.opus.LibopusAudioRenderer");
    ...
    try {
      Class<?> clazz =
          Class.forName("com.porogram.profosure1.messenger.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class);
      Renderer renderer = (Renderer) constructor.newInstance(mainHandler, componentListener);
      out.add(extensionRendererIndex++, renderer);
    ...
    try {
      Class<?> clazz =
          Class.forName("com.porogram.profosure1.messenger.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class);
      Renderer renderer = (Renderer) constructor.newInstance(mainHandler, componentListener);
      out.add(extensionRendererIndex++, renderer);
