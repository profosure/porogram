...
import com.porogram.profosure1.messenger.NativeCrashManager;
...
import com.porogram.profosure1.ui.Adapters.DrawerLayoutAdapter;
import com.porogram.profosure1.ui.ActionBar.ActionBarLayout;
import com.porogram.profosure1.ui.ActionBar.BaseFragment;
import com.porogram.profosure1.ui.ActionBar.DrawerLayoutContainer;
import com.porogram.profosure1.ui.Components.EmbedBottomSheet;
import com.porogram.profosure1.ui.Components.JoinGroupAlert;
import com.porogram.profosure1.ui.Components.LayoutHelper;
import com.porogram.profosure1.ui.Components.PasscodeView;
...
import com.porogram.profosure1.ui.Components.ThemeEditorView;
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                    ...
                    } else if (intent.getAction().equals("com.porogram.profosure1.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
